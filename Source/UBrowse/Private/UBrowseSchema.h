...
struct FBrowseGraphSchemaAction_BrowseMode : public FEdGraphSchemaAction
{
    ...
    {
        static FName Type("UBrowseGraphSchemaAction_BrowseMode");
        return Type;
    }

    FBrowseGraphSchemaAction_BrowseMode() : FEdGraphSchemaAction()
    {
    }

    FBrowseGraphSchemaAction_BrowseMode(
        const FText& InNodeCategory, const FText& InMenuDesc, const FText& InToolTip, const int32 InGrouping)
