...
void UBrowseNode::AllocateDefaultPins()
{
	...
	{
		GeneratedByPin = CreatePin(EEdGraphPinDirection::EGPD_Output, TEXT(""), TEXT(""), nullptr, false, false, TEXT("Generated By"));
		GeneratesPin = CreatePin(EEdGraphPinDirection::EGPD_Input, TEXT(""), TEXT(""), nullptr, false, false, TEXT("Generates"));		
	}
